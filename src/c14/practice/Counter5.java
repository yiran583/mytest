...
class Ticker2 extends Thread {
	...
	private TextField t = new TextField(10), pr = new TextField(30); // Display
																	// priority
	private int count = 0;
	...
	public void run() {
		while (true) {
			if (runFlag) {
				...
				pr.setText(Thread.currentThread().getName()+":"+Integer.toString(getPriority()));
			}
			//yield();
		}
	}
...
public class Counter5 extends Applet {
	private Button start = new Button("Start"), upMax = new Button("Inc Max Priority"), downMax = new Button(
			"Dec Max Priority");
